...
inputPhoto.addEventListener('input', () => {
    if (inputNameUpdate.value.length != 0 && inputCategoryUpdate.value.length != 0 && inputPhoneUpdate.value.length != 0 && inputDirectionUpdate.value.length != 0 && inputPhoto.value.length != 0 && inputBarrioUpdate.value.length != 0  && inputDescriptionUpdate.value.length != 0) {
...
inputNameUpdate.addEventListener('input', () => {
    if (inputNameUpdate.value.length != 0 && inputCategoryUpdate.value.length != 0 && inputPhoneUpdate.value.length != 0 && inputDirectionUpdate.value.length != 0 && inputBarrioUpdate.value.length != 0  && inputDescriptionUpdate.value.length != 0) {
        btnUpdate.classList.add('active')
        btnUpdate.disabled = false
    } else {
        btnUpdate.classList.remove('active')
...
inputBarrioUpdate.value = resJson.data.Barrio
inputDescriptionUpdate.value = resJson.data.Descripcion
...
btnUpdate.addEventListener('click', async () => {
    ...
    formData.append('Barrio', inputBarrioUpdate.value);
    formData.append('Descripcion', inputDescriptionUpdate.value);
